...
La virtualización de contenedores no exige de una máquina física para poder ejecutarse
mientras que un sistema de virtualización clásico necesita de un equipo físico anfitrión y un
hypervisor para realizar el control. En el caso del software necesario para la virtualización
de contenedores puede ejecutarse sin problemas sobre un servidor virtual como equipo
anfitrión, lo cual permite una mayor versatilidad.
